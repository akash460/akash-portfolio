...
import { Send, Mail, Phone, MapPin, Github, Linkedin, Instagram, CheckCircle2, AlertCircle, Loader2 } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-14">
          ...
          >
            ...
            <div className="space-y-5">
              ...
              <a
                ...
                className="flex items-center gap-3 text-sm text-zinc-400 hover:text-[#25D366] transition-colors group"
              >
                <div className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.06] group-hover:border-[#25D366]/30 group-hover:text-[#25D366] transition-colors">
            ...
            <div className="flex items-center gap-3 pt-4">
              ...
              {PERSONAL_INFO.instagram && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-lg border border-white/[0.06] text-zinc-500 hover:text-[#E4405F] hover:border-[#E4405F]/30 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-lg border border-white/[0.06] text-zinc-500 hover:text-[#25D366] hover:border-[#25D366]/30 transition-colors"
                aria-label="WhatsApp"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.301-.15-1.78-.878-2.056-.978-.276-.1-.477-.15-.678.15-.2.3-.778.978-.954 1.179-.175.2-.351.226-.652.075-.301-.15-1.272-.469-2.423-1.496-.895-.798-1.5-1.784-1.676-2.085-.175-.3-.019-.462.132-.612.136-.135.301-.35.452-.526.15-.175.2-.3.301-.5.1-.2.05-.376-.025-.526-.075-.15-.678-1.636-.929-2.242-.244-.59-.492-.51-.678-.52l-.578-.01c-.2 0-.526.075-.802.376s-1.054 1.03-1.054 2.51 1.08 2.91 1.23 3.111c.15.2 2.125 3.245 5.15 4.55 .72.31 1.282.495 1.72.634.723.23 1.38.197 1.9.12.58-.087 1.78-.727 2.03-1.43.25-.703.25-1.305.175-1.43-.075-.126-.276-.201-.577-.351zM12.04 2C6.516 2 2.023 6.49 2.023 12.012c0 1.94.557 3.75 1.523 5.28L2 22l4.858-1.503c1.472.88 3.187 1.387 5.016 1.387 5.524 0 10.017-4.49 10.017-10.012C21.891 6.49 17.564 2 12.04 2zm0 18.3c-1.61 0-3.11-.47-4.38-1.29l-.31-.2-2.88.89.91-2.8-.2-.33c-.92-1.33-1.41-2.91-1.41-4.56 0-4.58 3.73-8.31 8.31-8.31 4.58 0 8.31 3.73 8.31 8.31 0 4.58-3.73 8.31-8.31 8.31z" />
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href={`https://wa.me/${(PERSONAL_INFO.whatsapp || "919580836060").replace(/[^0-9]/g, "")}?text=${encodeURIComponent("Hi Akash, I came across your portfolio and would like to discuss a project.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full border border-emerald-500/30 bg-[#25D366]/10 text-emerald-300 hover:bg-[#25D366]/20 hover:text-white font-semibold text-sm transition-all duration-300 hover:shadow-[0_0_25px_rgba(37,211,102,0.25)]"
              >
